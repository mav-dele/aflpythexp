...
## When expectation is reality (actuals)

Having found our "optimal" $k$, we create a Pythagorean table and calculate expected wins and win percentage. The below table provides a snapshot of the 2022 season. 
